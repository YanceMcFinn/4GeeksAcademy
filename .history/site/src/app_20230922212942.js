  ...
  function StudentListing (props){
    ...
    return (
        <div className='studentRow row p-1 justify-content-around'>
            <div className='col-md-4 float-start text-secondary d-inline-block text-wrap'>
                <div className='studentName'>{props.name}</div>
                <div className='motto'>{props.motto}</div>
            </div>
            <div className='col-md-6 float-end float-sm-start d-flex align-items-start justify-content-end py-2'>
